...
from core.document_processor import segment_document, splitter_text
from core.vector import create_emd_vet
...
if st.button("Process Audio"):
    ...
    if not source:
        ...
        with st.spinner("Processing audio..."):
            ...
            documents = segment_document(all_segments)

            # Split documents
            rag_chunks = splitter_text(documents)

            # Create vector store
            vector_store = create_emd_vet(rag_chunks)
